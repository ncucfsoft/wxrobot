...
public:
	...
	void DrawTransparent(BOOL bTransparrent,BOOL bRepaint = FALSE);
	...
	DWORD SetIcon(LPCTSTR nIconpathIn, LPCTSTR nIconpathOut);
	DWORD SetBitmaps(LPCTSTR nBitmapPathIn, COLORREF crTransColorIn, LPCTSTR nBitmapPathOut=NULL, COLORREF crTransColorOut=0);
